...
-- 회원 등록(비번 1234)
INSERT INTO MEMBER (NAME, PASSWORD, EMAIL, HP, STATUS, CREATE_BY, LAST_MODIFIED_BY, CREATED_DATE, LAST_MODIFIED_DATE) VALUES ('관리자', '$2a$10$is4cfHcYBgNPhcTMW2e8c.gd0EdqYShhhicWddNX28zfQUQkDJrq2', 'admin@naver.com', '010-1111-2222', 'ACTIVITY', 'admin@naver.com', 'admin@naver.com', NOW(), NOW());
INSERT INTO MEMBER (NAME, PASSWORD, EMAIL, HP, STATUS, CREATE_BY, LAST_MODIFIED_BY, CREATED_DATE, LAST_MODIFIED_DATE) VALUES ('회원', '$2a$10$is4cfHcYBgNPhcTMW2e8c.gd0EdqYShhhicWddNX28zfQUQkDJrq2', 'member@naver.com', '010-1234-5678', 'ACTIVITY', 'member@naver.com', 'member@naver.com', NOW(), NOW());
