-- 사이트 등록
INSERT INTO SITE (SITE_ID, SITE_NAME, DESCRIPTION) VALUES (1, '관리자', '관리자 사이트');
...
-- 테스트 메뉴 그룹 등록
INSERT INTO MENU_GROUP (MENU_GROUP_ID, GROUP_NAME, SITE_ID) VALUES (1, '관리자', 1);

-- 테스트 메뉴 등록
INSERT INTO MENU (MENU_ID, MENU_GROUP_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (1, 1, NOW(), NOW(), 'admin@naver.com', 'admin@naver.com', '서울소식', 0, 'MT_MENU', '서울소식', 2, 'Y', null, null);
INSERT INTO MENU (MENU_ID, MENU_GROUP_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (2, 1, NOW(), NOW(), 'admin@naver.com', 'admin@naver.com', '새소식', 1, 'MT_MENU', '새소식', 1, 'Y', 1, 1);
INSERT INTO MENU (MENU_ID, MENU_GROUP_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (3, 1, NOW(), NOW(), 'admin@naver.com', 'admin@naver.com', '서울시 정책 뉴스', 1, 'MT_BOARD', '서울시 정책 뉴스', 2, 'Y', 1, 1);
INSERT INTO MENU (MENU_ID, MENU_GROUP_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (4, 1, NOW(), NOW(), 'admin@naver.com', 'admin@naver.com', '보도해명자료', 1, 'MT_BOARD', '보도해명자료', 3, 'Y', 1, 1);
INSERT INTO MENU (MENU_ID, MENU_GROUP_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (5, 1, NOW(), NOW(), 'admin@naver.com', 'admin@naver.com', '보도자료', 2, 'MT_BOARD', '보도자료', 1, 'Y', 4, 1);
INSERT INTO MENU (MENU_ID, MENU_GROUP_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (6, 1, NOW(), NOW(), 'admin@naver.com', 'admin@naver.com', '해명자료', 2, 'MT_BOARD', '해명자료', 2, 'Y', 4, 1);
INSERT INTO MENU (MENU_ID, MENU_GROUP_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (7, 1, NOW(), NOW(), 'admin@naver.com', 'admin@naver.com', '이벤트 신청', 2, 'MT_BOARD', '이벤트 신청', 3, 'Y', 2, 1);
INSERT INTO MENU (MENU_ID, MENU_GROUP_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (8, 1, NOW(), NOW(), 'admin@naver.com', 'admin@naver.com', '분야별 새소식', 2, 'MT_BOARD', '분야별 새소식', 1, 'Y', 2, 1);
INSERT INTO MENU (MENU_ID, MENU_GROUP_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (9, 1, NOW(), NOW(), 'admin@naver.com', 'admin@naver.com', '이달의 행사 및 축제', 2, 'MT_BOARD', '이달의 행사 및 축제', 2, 'Y', 2, 1);
INSERT INTO MENU (MENU_ID, MENU_GROUP_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (10, 1, NOW(), NOW(), 'admin@naver.com', 'admin@naver.com', '시민참여', 0, 'MT_BOARD', '시민참여', 1, 'Y', null, null);
INSERT INTO MENU (MENU_ID, MENU_GROUP_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (11, 1, NOW(), NOW(), 'admin@naver.com', 'admin@naver.com', '서울시민과의 대화', 1, 'MT_CONTENTS', '서울시민과의 대화', 1, 'Y', 10, 10);
