...
INSERT INTO AUTHORITY (AUTHORITY, AUTHORITY_NAME, AUTHORITY_TYPE, CREATE_BY, LAST_MODIFIED_BY, CREATED_DATE, LAST_MODIFIED_DATE) VALUES ('ROLE_USER_1', '브론즈', 'MEMBER', 'admin', 'admin', NOW(), NOW());
INSERT INTO AUTHORITY (AUTHORITY, AUTHORITY_NAME, AUTHORITY_TYPE, CREATE_BY, LAST_MODIFIED_BY, CREATED_DATE, LAST_MODIFIED_DATE) VALUES ('ROLE_USER_2', '실버', 'MEMBER', 'admin', 'admin', NOW(), NOW());
INSERT INTO AUTHORITY (AUTHORITY, AUTHORITY_NAME, AUTHORITY_TYPE, CREATE_BY, LAST_MODIFIED_BY, CREATED_DATE, LAST_MODIFIED_DATE) VALUES ('ROLE_USER_3', '골드', 'MEMBER', 'admin', 'admin', NOW(), NOW());
