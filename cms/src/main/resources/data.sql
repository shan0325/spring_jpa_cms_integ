...
-- 테스트 메뉴 등록
INSERT INTO MENU (MENU_ID, MENU_GROUP_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (1, 1, NOW(), NOW(), 'admin', 'admin', '시스템', 0, 'MT_MENU', '시스템', 9, 'Y', null, null);
INSERT INTO MENU (MENU_ID, MENU_GROUP_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (2, 1, NOW(), NOW(), 'admin', 'admin', '코드설정', 1, 'MT_MENU', '코드설정', 1, 'Y', 1, 1);
INSERT INTO MENU (MENU_ID, MENU_GROUP_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (3, 1, NOW(), NOW(), 'admin', 'admin', '메뉴설정', 1, 'MT_MENU', '메뉴설정', 2, 'Y', 1, 1);
INSERT INTO MENU (MENU_ID, MENU_GROUP_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (100, 1, NOW(), NOW(), 'admin', 'admin', '서울소식', 0, 'MT_MENU', '서울소식', 1, 'Y', null, null);
INSERT INTO MENU (MENU_ID, MENU_GROUP_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (101, 1, NOW(), NOW(), 'admin', 'admin', '새소식', 1, 'MT_MENU', '새소식', 1, 'Y', 100, 100);
INSERT INTO MENU (MENU_ID, MENU_GROUP_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (102, 1, NOW(), NOW(), 'admin', 'admin', '서울시 정책 뉴스', 1, 'MT_BOARD', '서울시 정책 뉴스', 2, 'Y', 100, 100);
INSERT INTO MENU (MENU_ID, MENU_GROUP_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (103, 1, NOW(), NOW(), 'admin', 'admin', '보도해명자료', 1, 'MT_BOARD', '보도해명자료', 3, 'Y', 100, 100);
INSERT INTO MENU (MENU_ID, MENU_GROUP_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (104, 1, NOW(), NOW(), 'admin', 'admin', '보도자료', 2, 'MT_BOARD', '보도자료', 1, 'Y', 103, 100);
INSERT INTO MENU (MENU_ID, MENU_GROUP_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (105, 1, NOW(), NOW(), 'admin', 'admin', '해명자료', 2, 'MT_BOARD', '해명자료', 2, 'Y', 103, 100);
INSERT INTO MENU (MENU_ID, MENU_GROUP_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (106, 1, NOW(), NOW(), 'admin', 'admin', '이벤트 신청', 2, 'MT_BOARD', '이벤트 신청', 3, 'Y', 101, 100);
INSERT INTO MENU (MENU_ID, MENU_GROUP_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (107, 1, NOW(), NOW(), 'admin', 'admin', '분야별 새소식', 2, 'MT_BOARD', '분야별 새소식', 1, 'Y', 101, 100);
INSERT INTO MENU (MENU_ID, MENU_GROUP_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (108, 1, NOW(), NOW(), 'admin', 'admin', '이달의 행사 및 축제', 2, 'MT_BOARD', '이달의 행사 및 축제', 2, 'Y', 101, 100);
INSERT INTO MENU (MENU_ID, MENU_GROUP_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (109, 1, NOW(), NOW(), 'admin', 'admin', '시민참여', 0, 'MT_BOARD', '시민참여', 2, 'Y', null, null);
INSERT INTO MENU (MENU_ID, MENU_GROUP_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (110, 1, NOW(), NOW(), 'admin', 'admin', '서울시민과의 대화', 1, 'MT_CONTENTS', '서울시민과의 대화', 1, 'Y', 109, 109);
